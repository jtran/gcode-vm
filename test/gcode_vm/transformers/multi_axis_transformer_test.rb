...
describe GcodeVm::MultiAxisTransformer do
  ...
  it "allows access to a single axis transformer" do
    _(transformer.call('G1 X1 c10 d100')).must_equal('G1 X1 c10.0 d100.0')

    transformer.axis('c').amount = 2.0
    _(transformer.call('G1 X2 c10 d100')).must_equal('G1 X2 c12.0 d100.0')
  end
  ...
  it "passes keyword arguments to factory" do
    ...
    _(t.axis('c').gcode_formatter).must_be_same_as gcode_formatter
  end
